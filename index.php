...
if (!isset($_GET['id'])) {
    echo '<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><title>Enji Player</title><link rel="stylesheet" href="main.css"></head><body><div id="Header"><h1>Enji Player</h1><p>A music playing software for streamers</p><br><hr style="width: 80%"><br></div><div>';
    foreach ($users as $user) {
        echo "<a href='?id=" . $user['user_uri'] . "'>" . $user['user'] . "</a><br>";
    }
    echo '</div></body></html>';
    exit();
}
...
<script>
    ...
    if (isset($requestedby)) {
        echo 'setTimeout(function(){$(\'#requested\').remove(); },17000);';
    }
    ?>
